...
class ThemeNotifier with ChangeNotifier {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    iconTheme: IconThemeData(color: Colors.blueGrey), bottomAppBarTheme: BottomAppBarTheme(color: Colors.black.withOpacity(0.1)), colorScheme: ColorScheme.fromSwatch().copyWith(
      ...
      secondary: Colors.black.withOpacity(.15)).copyWith(background: Colors.white.withOpacity(0.15)).copyWith(error: Colors.white.withOpacity(0.3)),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    iconTheme: IconThemeData(color: Colors.blueGrey[200]),
      ...
      secondary: Colors.black.withOpacity(.2)).copyWith(background: Color(0xff2b2b2b).withOpacity(.05)).copyWith(error: Color(0xff1e1e1e).withOpacity(0.4)), //darkMode button
  );
